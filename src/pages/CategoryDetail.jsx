...
function CategoryDetail() {
    ...
    useEffect(() => {
        let mounted = true;
        console.log("CategoryDetail mounted with slug:", slug);
            ...
            .then((fetchedPost) => {
                if (mounted) {
                    if (fetchedPost) {
                        ...
                        setPost(fetchedPost);
                        // Generate Table of Contents with consistent IDs
            ...
            <div className="breadcrumb">
                <div className="breadcrumb__wrapper">
                    <ul className="breadcrumb__list">
                        ...
                        {/* <li className="breadcrumb__item">
                            <a href="/category" className="breadcrumb__link">お役立ちコラム</a>
                        </li> */}
                        <li className="breadcrumb__item">
                            <a href="/hoip_headless/category/{post.categories[0]}" className="breadcrumb__link">{categoryNames[post.categories[0]]}</a>
                        </li>
                        <li
                    ...
                    <div className="category-detail__block">
                        ...
                        <div className="category-detail__content">
                            <div className="ofukuwake__row">
                                <RelatedPosts relatedPosts={relatedPosts} categories={categories} /> {/* Pass categories */}
                            </div>
                        </div>
                    </div>
                </section>
